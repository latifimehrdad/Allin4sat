package ir.bppir.allin4sat.background;
...
import ir.bppir.allin4sat.models.MD_Notification;
...
public class NotificationNew {
    ...
    private String CHANNEL_ONE_ID = "ir.bppir.allin4sat.PishtazanNotification";
